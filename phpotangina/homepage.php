...
?>
    ...
    <section class="section__container plans__container" id="plans">
      <h2 class="section__header">Our Plans</h2>
      <p class="section__description">
        Choose from our range of plans to find the best fit for your pet's health needs.
      </p>
    ...
    <section class="section__container" id="account">
